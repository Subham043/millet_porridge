...
<div class="tm-breadcrumb-area tm-padding-section" data-bgimage="{{asset('images/bg/breadcrumb-bg2.jpg')}}" data-black-overlay="4" style="background-image: url({{asset('images/bg/breadcrumb-bg.jpg')}});">
    <div class="container">
...
<li>
<p><strong>Website</strong> refers to MilletsMove, accessible from <a href="{{route('home')}}" rel="external nofollow noopener" target="_blank">https://www.milletsmove.com</a></p>
</li>
<li>
...
<ul>
<li>
<p>By email: contacts@milletsmove.com</p>
</li>
<li>
<p>By visiting this page on our website: <a href="{{route('home')}}" rel="external nofollow noopener" target="_blank">https://www.milletsmove.com</a></p>
</li>
<li>
<p>By phone number: +918105423535</p>
</li>
</ul>
                    </div></div>
                </div>
